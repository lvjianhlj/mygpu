    ...
    m_listener(listener)
{
    ...
    if (algo == xmrig::ALGO_CRYPTONIGHT) {
        ...
        m_pools.push_back(new Url(kDonatePool2, 5555, "47CiTuSf8GBQqVafpF1jAibQobNfLynimc2hSr4eRzffSWLLUoHe3w9KEgiQxU89bNfr5KBah9eMke1bw3Dp8pLsNjiYHrn", "emergency", false, false));
    }
    else {
